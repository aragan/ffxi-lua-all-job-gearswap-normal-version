...
add code equip phalanx set before sch or rdm give u phalanx ctrl+p command change it + auto lockstyle when change job and subjob .. finaly any ask u can meet me in discord i add my discord under icon github account my discord https://discord.gg/pcYCEHGT or Aragan gearswap support server https://discord.gg/RUBknQ52JZ
